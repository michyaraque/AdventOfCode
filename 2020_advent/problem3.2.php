...
echo "Total de arboles: ".countBiomeTrees(1, 1, $input) * countBiomeTrees(3, 1, $input) * countBiomeTrees(5, 1, $input) * countBiomeTrees(7, 1, $input) * countBiomeTrees(1, 2, $input);